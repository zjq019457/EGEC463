...
EXPERIMENTS = {
    ...
    "medical_nano_640": {
        "description": "Small-object recall experiment: YOLO11n + 640px + lighter medical-image augmentation.",
        "model_size": "nano",
        "epochs": 50,
        "batch_size": 8,
        "image_size": 640,
    ...
    "medical_small_640": {
        "description": "Higher-capacity small-object experiment: YOLO11s + 640px + lighter medical-image augmentation.",
        "model_size": "small",
        "epochs": 50,
        "batch_size": 8,
        "image_size": 640,
    ...
    "medical_medium_640": {
        "description": "Medium model comparison: YOLO11m + 640px for capacity-vs-speed analysis.",
        "model_size": "medium",
        "epochs": 50,
        "batch_size": 4,
        "image_size": 640,
